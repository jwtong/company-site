...
class WebScrapeDcfPage extends React.Component<Props> {
  public render() {
    ...
    const webScrapeDcfRoles = services.filter((role) =>
    ...
    return (
      ...
      >
        ...
        <Typography variant="subtitle1" gutterBottom>
          ...
          value of an investment based on future cash flows. In layman&apos;s
          terms, it is a powerful tool that can help predict the fair value
          price of a stock. Without a Bloomberg machine, the process of entering
          data and generating such a model may take a few hours. This program
          similarly features automatic input of hundreds of fields of data
          (scraped from Yahoo Finance), and has buttons that allow for easy
          parametization, expediting the process to minutes.
        </Typography>
        <div className={classes.topBottomImageWrapper}>
          <Img
